    ...
    return (
        <Container rss>
            <div>
                ...
                <p className="mt-4">
                    I'm an Australian student, badminton player and hobby
                    software developer. I'm currently working on multiple
                    projects, but in my free time I enjoy exploring the web,
...
function ProjectCard({
    ...
    project: InferGetStaticPropsType<typeof getStaticProps>['projects'][number];
}) {
    return (
        <a
            href={`/projects/${project.slug}`}
            className="p-3 w-full rounded-md dark:border-2 border-orange-500/30 bg-orange-100/70 dark:bg-neutral-800/20 dark:border-neutral-700/10"
        >
