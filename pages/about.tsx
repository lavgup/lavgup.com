	...
	return (
		...
		>
			...
			<p className="mt-6 w-full max-w-none text-gray-600 prose dark:prose-dark">
				...
				I enjoy frontend web development, occasionally dabbling into backend development.
				I love building web applications - the challenges are what make it fun.
				<br />
				<br />

				Check out <A href="/stack">my stack</A> and <A href="/blog">blog</A>!
			</p>
		</Container>
	);
}
