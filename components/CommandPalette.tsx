        ...
        },
        {
            ...
            perform: async () => {
                ...
                toast.success('Copied to clipboard!', {
                    className:
                        'text-neutral-600 dark:text-neutral-200/[.85] bg-white dark:bg-neutral-800',
                    duration: 3000
                });
            }
        },
...
function Breadcrumb({ text, query }: { text: string; query: KBarQuery }) {
    return (
        <button
            ...
            onClick={() =>
                query.setCurrentRootAction(text === 'home' ? '' : text)
            }
        >
            {text}
        </button>
        ...
        <div className="relative" ref={wrapperRef}>
            <KBarResults
                ...
                onRender={({ item, active }) =>
                    typeof item === 'string' ? (
                        <p className="pt-3 pb-1 pl-3 text-[.65rem] uppercase dark:text-neutral-300/50">
                            {item}
                        </p>
                    ) : (
                        <ResultItem
